...
Contaminated.Test <- function(n,dimen,alpha = 0.05, replicate = 1000,nlambda = c(50,20),
    ...
    Test.stat <- foreach(iter = 1:replicate,.combine = rbind,
                         .packages = c("tensr","ramify","stats",'rTensor','expm',
                                       "Tlasso","glasso","MASS"))%dopar%{
                                         ...
                                         Data <- Generate.Contaminated(n = n,dimen = dimen,Omega = Omega,seed = seed.value,
